  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="/StoreWS">Home</a>
        </li>
       
     
      </ul>
                <form class="d-flex" style="margin-right:200px" action="searchproducts.jsp" role="search" onsubmit="return validateSearch()">
          <input class="form-control me-2 " name="search" id="search" type="search" placeholder="Search" aria-label="Search">
          <button class="btn btn-success" type="submit">Search</button>
        </form> 
         <p class="nav-item"style="margin-top:15px;padding-right:20px">
         <button class="btn btn-outline-success"> <a class="nav-link" href="Auth/Userlogin.jsp">Sing-in</a></button> 
        </p>
        <p class="nav-item" style="margin-top:15px">
         <button class="btn btn-outline-success"><a class="nav-link" href="Auth/Userregister.jsp">Sing-Up</a></button> 
        </p>
            ...
            <div class="col-md-3">
                <div class="card" style="width: 100%;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="Auth/Userlogin.jsp" class="btn btn-primary" style="margin-left:150px;paddin-left:20px">Buy</a>
                        
<!--                         <a href="client/Userlogin.jsp" class="btn btn-warning" style="margin-left: 80px">Add</a> -->
                    </div>
                </div>
            </div>
        <% 
